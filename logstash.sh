...
dir=`pwd`
curl -O https://artifacts.elastic.co/downloads/logstash/logstash-7.13.0-linux-x86_64.tar.gz --output arthas
#wget https://artifacts.elastic.co/downloads/logstash/logstash-7.2.0-linux-x86_64.tar.gz
tar -zxvf ${dir}/logstash-7.13.0-linux-x86_64.tar.gz
...
mv guled_conf ${dir}/logstash-7.13.0
echo "Install complete"
echo "Please edit your config file , And run : ./logstash-7.13.0/bin/logstash -f ./logstash-7.13.0/guled_conf/conf/mysql.conf"